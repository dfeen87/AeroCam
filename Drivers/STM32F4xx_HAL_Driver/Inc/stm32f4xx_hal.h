 ...
 *
 * Minimal STM32F4xx HAL stub for AeroCam CI compilation.
 * Provides the types, macros, and static-inline function stubs consumed by
 * mcu_hal.hpp, spi_dma.hpp, and main.cpp when MCU=F4.
 *
 ...
 * full STM32CubeF4 SDK present in the repository.
 */
