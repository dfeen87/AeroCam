...
exports.AeroCoreService = void 0;
const MotionEventBus_1 = require("./MotionEventBus");
class AeroCoreService {
    static instance;
    eventBus;
    currentState;
    lastVelocityMagnitude = 0;
    constructor() {
        this.eventBus = MotionEventBus_1.MotionEventBus.getInstance();
    ...
    ingestMotionState(partialState) {
    ...
    evaluateAndPublishEvents() {
        ...
        const velMag = Math.sqrt(state.motionFrame.globalDx * state.motionFrame.globalDx +
...
exports.AeroCoreService = AeroCoreService;
//# sourceMappingURL=AeroCoreService.js.map